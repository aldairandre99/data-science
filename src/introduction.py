...
num_friends_by_id.sort(                         # Sort the list
    key=lambda id_and_friend: id_and_friend[1], # by num_friends
...
def friends_of_friends(user):
    ...
    return Counter(
        foaf_id
        for friend_id in friendships[user["id"]] # For each of my friends,
        for foaf_id in friendships[friend_id] # and aren't my friends.
